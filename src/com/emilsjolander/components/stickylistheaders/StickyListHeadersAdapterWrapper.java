 ...
 */
public class StickyListHeadersAdapterWrapper extends BaseAdapter implements
	...
	public final StickyListHeadersAdapter delegate;
	...
	public StickyListHeadersAdapterWrapper(Context context,
	...
	public boolean isHeader(View v) {
	...
	public void registerInternalDataSetObserver(DataSetObserver observer) {
		internalObservable.registerObserver(observer);
	}

	public void unregisterInternalDataSetObserver(DataSetObserver observer) {
	...
	public int translateListViewPosition(int position) {
		int viewType = getItemViewType(position);
		if (viewType == headerViewType) {
